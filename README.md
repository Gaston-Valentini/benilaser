...
Este proyecto consiste en el desarrollo de la página web de [Benilaser](https://www.benilaser.es), una clínica especializada en eliminación láser
ubicada en Benidorm, Alicante, España. Se trata de un trabajo freelance cuyo objetivo es proporcionar a los clientes información detallada sobre los
servicios que ofrece la clínica, así como otros aspectos importantes, como el horario de atención, la ubicación, el equipo utilizado y las facilidades
de contacto.
...
-   Presentación visual del contenido mediante la implementación de carruseles con la librería
    [react-slick](https://www.npmjs.com/package/react-slick).
-   Implementación de elementos de diseño como íconos con la librería de [react-icons](https://react-icons.github.io/react-icons/) y un pequeño switch
    con la librería de [react-switch](https://www.npmjs.com/package/react-switch).
